...
df4 = pd.read_csv('data/Training_data2_part_1.csv')
df5 = pd.read_csv('data/Training_data2_part_2.csv')
df6= pd.read_csv('data/Training_data2_part_3.csv')
df7 = pd.read_csv('data/Training_data2_part_4.csv')
df8 = pd.read_csv('data/Training_data2_part_5.csv')
df9 = pd.read_csv('data/Training_data2_part_6.csv')
df10 = pd.read_csv('data/Training_data2_part_7.csv')
df11 = pd.read_csv('data/Training_data2_part_8.csv')
df12 = pd.read_csv('data/Training_data2_part_9.csv')
...
print(f"  - Training_data2_part_1.csv: {len(df4)} rows")
print(f"  - Training_data2_part_2.csv: {len(df5)} rows")
print(f"  - Training_data2_part_3.csv: {len(df6)} rows")
print(f"  - Training_data2_part_4.csv: {len(df7)} rows")
print(f"  - Training_data2_part_5.csv: {len(df8)} rows")
print(f"  - Training_data2_part_6.csv: {len(df9)} rows")
print(f"  - Training_data2_part_7.csv: {len(df10)} rows")
print(f"  - Training_data2_part_8.csv: {len(df11)} rows")
print(f"  - Training_data2_part_9.csv: {len(df12)} rows")
